...
export default function Settings({ activeSkinId, onSkinChange }: Props) {
  ...
  return (
    <div className="flex h-full bg-[#1e1e24]/90 text-xs select-none backdrop-blur-3xl text-white/90" style={{ fontFamily: "'SF Pro', -apple-system, sans-serif" }}>
      {/* ══════════════════════════════════════════════ 1. macOS System Settings Left Sidebar */}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-black/10">
        ...
        <div className="flex-1 p-6 overflow-y-auto space-y-6">
          ...
          {/* Settings Section Card 1: System Info & Options */}
          ...
          {/* Settings Section Card 2: Operating System Selection Grid */}
          ...
          {/* Settings Section Card 3: Maintenance & Cache */}
