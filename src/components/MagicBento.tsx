...
/**
 * MagicBento — interactive project grid (adapted from React Bits).
 *
 * Renders the portfolio `projects` as a responsive bento layout with four
 * cursor-driven effects, all themed to the "Stdout" mint accent:
 *   - Stars    : gsap particles spawn on hover
 *   - Spotlight: a single global radial follows the cursor across the grid
 *   - Border   : each card's border glows toward the cursor
 *   - Tilt/Magnetism/Click ripple per card
 *
 * All animations auto-disable on mobile (<=768px) for performance.
 */
